      ...
      CREATE   PROCEDURE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback] qw
