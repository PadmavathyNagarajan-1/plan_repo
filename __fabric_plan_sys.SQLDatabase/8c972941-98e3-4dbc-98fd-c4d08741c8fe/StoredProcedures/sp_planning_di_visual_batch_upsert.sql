        ...
        CREATE   PROCEDURE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [8c972941-98e3-4dbc-98fd-c4d08741c8fe].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [8c972941-98e3-4dbc-98fd-c4d08741c8fe].' + QUOTENAME(@DIVTableName) + ' AS div
