              ...
              CREATE PROCEDURE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].powertable_approval_request_rows SET status = 500 FROM [8c972941-98e3-4dbc-98fd-c4d08741c8fe].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
