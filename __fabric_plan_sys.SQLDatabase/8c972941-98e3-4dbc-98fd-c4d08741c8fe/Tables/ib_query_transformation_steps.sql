CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_transformation_steps]([recordGuid] ASC);
