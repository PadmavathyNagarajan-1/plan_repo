CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_source]([recordGuid] ASC);
