CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_row_access_filters]([recordGuid] ASC);
