CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_automation]([recordGuid] ASC);
