CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_filter]([recordGuid] ASC);
