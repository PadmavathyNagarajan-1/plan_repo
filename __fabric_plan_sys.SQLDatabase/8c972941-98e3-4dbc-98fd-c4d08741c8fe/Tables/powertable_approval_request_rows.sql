CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_request] ([id])
);
