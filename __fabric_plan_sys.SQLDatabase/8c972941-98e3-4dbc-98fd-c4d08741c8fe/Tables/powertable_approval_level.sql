CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_level]([recordGuid] ASC);
