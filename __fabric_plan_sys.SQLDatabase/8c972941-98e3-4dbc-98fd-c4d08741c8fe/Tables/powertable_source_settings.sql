CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source_settings]([recordGuid] ASC);
