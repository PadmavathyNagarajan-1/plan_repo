CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[writeback_settings]([recordGuid] ASC);
