CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback_settings]([recordGuid] ASC);
