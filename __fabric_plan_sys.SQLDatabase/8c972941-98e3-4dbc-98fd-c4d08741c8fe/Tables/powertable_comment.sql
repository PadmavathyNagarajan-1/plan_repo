CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source] ([id])
);
