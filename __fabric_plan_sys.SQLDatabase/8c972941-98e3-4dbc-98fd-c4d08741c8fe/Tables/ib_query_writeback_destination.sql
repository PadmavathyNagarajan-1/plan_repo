CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[ib_query_writeback_destination]([recordGuid] ASC);
