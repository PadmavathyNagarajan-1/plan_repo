CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_column_config]([recordGuid] ASC);
