CREATE TABLE [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [8c972941-98e3-4dbc-98fd-c4d08741c8fe].[powertable_approval_request] ([id])
);
