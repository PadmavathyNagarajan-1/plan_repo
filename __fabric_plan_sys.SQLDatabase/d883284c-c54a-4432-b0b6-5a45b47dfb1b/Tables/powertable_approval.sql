CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval]([recordGuid] ASC);
