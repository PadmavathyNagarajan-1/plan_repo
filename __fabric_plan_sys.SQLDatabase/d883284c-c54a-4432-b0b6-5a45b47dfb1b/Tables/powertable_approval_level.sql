CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_level]([recordGuid] ASC);
