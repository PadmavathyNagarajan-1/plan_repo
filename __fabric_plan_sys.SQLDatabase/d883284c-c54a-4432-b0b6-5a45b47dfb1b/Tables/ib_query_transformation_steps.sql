CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_transformation_steps]([recordGuid] ASC);
