CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[visual] ([id])
);
