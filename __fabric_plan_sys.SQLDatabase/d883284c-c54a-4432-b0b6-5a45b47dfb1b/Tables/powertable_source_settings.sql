CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source_settings]([recordGuid] ASC);
