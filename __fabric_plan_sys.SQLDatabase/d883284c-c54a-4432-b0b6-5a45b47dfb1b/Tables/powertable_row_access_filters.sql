CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_row_access_filters]([recordGuid] ASC);
