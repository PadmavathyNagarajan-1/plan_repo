CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_source]([recordGuid] ASC);
