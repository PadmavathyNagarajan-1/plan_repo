CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_filter]([recordGuid] ASC);
