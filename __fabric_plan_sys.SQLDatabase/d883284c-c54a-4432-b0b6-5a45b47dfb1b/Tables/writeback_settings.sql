CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[writeback_settings]([recordGuid] ASC);
