CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_request] ([id])
);
