CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_automation_jobs] ([id])
);
