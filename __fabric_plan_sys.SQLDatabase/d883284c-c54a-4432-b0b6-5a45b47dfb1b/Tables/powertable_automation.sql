CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_automation]([recordGuid] ASC);
