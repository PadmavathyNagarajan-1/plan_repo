CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_writeback_destination]([recordGuid] ASC);
