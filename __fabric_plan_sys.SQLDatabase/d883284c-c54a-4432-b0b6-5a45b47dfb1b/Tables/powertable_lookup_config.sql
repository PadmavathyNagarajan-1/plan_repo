CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_lookup_config]([recordGuid] ASC);
