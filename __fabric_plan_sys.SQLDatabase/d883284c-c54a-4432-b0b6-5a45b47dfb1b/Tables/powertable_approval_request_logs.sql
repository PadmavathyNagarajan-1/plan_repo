CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_approval_request] ([id])
);
