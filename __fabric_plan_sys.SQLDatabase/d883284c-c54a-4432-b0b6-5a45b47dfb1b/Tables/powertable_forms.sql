CREATE TABLE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[powertable_forms]([recordGuid] ASC);
