      ...
      CREATE   PROCEDURE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[ib_query_writeback] qw
