                          ...
                          CREATE PROCEDURE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [d883284c-c54a-4432-b0b6-5a45b47dfb1b].powertable_approval_request_rows
