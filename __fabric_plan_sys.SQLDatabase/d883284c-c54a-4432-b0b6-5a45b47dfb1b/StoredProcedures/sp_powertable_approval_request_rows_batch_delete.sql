              ...
              CREATE PROCEDURE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [d883284c-c54a-4432-b0b6-5a45b47dfb1b].powertable_approval_request_rows SET status = 500 FROM [d883284c-c54a-4432-b0b6-5a45b47dfb1b].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
