CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_forms]([recordGuid] ASC);
