CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval]([recordGuid] ASC);
