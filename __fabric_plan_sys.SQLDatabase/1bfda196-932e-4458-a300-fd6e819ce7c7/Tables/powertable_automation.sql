CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_automation]([recordGuid] ASC);
