CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback_settings]([recordGuid] ASC);
