CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback_destination]([recordGuid] ASC);
