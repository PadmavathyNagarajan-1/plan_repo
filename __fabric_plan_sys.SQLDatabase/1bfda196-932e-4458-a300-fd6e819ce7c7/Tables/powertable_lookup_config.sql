CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_lookup_config]([recordGuid] ASC);
