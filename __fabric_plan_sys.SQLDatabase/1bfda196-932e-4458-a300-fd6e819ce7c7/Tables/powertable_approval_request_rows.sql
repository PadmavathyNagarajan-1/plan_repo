CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_request] ([id])
);
