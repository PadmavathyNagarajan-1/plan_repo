CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_filter]([recordGuid] ASC);
