CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_automation_jobs] ([id])
);
