CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[visual] ([id])
);
