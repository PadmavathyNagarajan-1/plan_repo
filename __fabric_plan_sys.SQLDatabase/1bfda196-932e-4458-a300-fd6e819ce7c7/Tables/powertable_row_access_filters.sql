CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_row_access_filters]([recordGuid] ASC);
