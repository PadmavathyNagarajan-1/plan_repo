CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_request] ([id])
);
