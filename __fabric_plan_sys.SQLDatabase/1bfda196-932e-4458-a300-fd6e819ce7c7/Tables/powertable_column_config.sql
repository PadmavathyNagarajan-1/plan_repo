CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_column_config]([recordGuid] ASC);
