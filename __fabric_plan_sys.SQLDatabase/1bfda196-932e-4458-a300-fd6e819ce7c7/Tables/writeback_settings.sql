CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[writeback_settings]([recordGuid] ASC);
