CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[visual] ([id]) ON DELETE CASCADE
);
