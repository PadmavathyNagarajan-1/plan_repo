CREATE TABLE [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [1bfda196-932e-4458-a300-fd6e819ce7c7].[powertable_approval_level]([recordGuid] ASC);
