              ...
              CREATE PROCEDURE [1bfda196-932e-4458-a300-fd6e819ce7c7].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [1bfda196-932e-4458-a300-fd6e819ce7c7].powertable_approval_request_rows SET status = 500 FROM [1bfda196-932e-4458-a300-fd6e819ce7c7].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
