      ...
      CREATE   PROCEDURE [1bfda196-932e-4458-a300-fd6e819ce7c7].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [1bfda196-932e-4458-a300-fd6e819ce7c7].[ib_query_writeback] qw
