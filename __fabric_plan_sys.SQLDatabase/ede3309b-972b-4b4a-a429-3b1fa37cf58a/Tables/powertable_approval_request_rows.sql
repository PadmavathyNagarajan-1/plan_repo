CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_request] ([id])
);
