CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_transformation_steps]([recordGuid] ASC);
