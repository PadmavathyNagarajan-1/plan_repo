CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_automation]([recordGuid] ASC);
