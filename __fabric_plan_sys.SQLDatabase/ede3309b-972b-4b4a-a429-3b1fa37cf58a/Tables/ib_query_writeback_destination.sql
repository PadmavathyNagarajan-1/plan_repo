CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback_destination]([recordGuid] ASC);
