CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_request] ([id])
);
