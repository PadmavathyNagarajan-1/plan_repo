CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_level]([recordGuid] ASC);
