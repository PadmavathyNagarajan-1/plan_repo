CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_row_access_filters]([recordGuid] ASC);
