CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source_settings]([recordGuid] ASC);
