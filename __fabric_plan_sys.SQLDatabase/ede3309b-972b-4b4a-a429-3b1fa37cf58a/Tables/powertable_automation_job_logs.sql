CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_automation_jobs] ([id])
);
