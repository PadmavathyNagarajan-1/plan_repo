CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source] ([id])
);
