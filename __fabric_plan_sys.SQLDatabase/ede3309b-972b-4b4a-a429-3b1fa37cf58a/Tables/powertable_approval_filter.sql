CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_approval_filter]([recordGuid] ASC);
