CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[visual] ([id]) ON DELETE CASCADE
);
