CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_source]([recordGuid] ASC);
