CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback_settings]([recordGuid] ASC);
