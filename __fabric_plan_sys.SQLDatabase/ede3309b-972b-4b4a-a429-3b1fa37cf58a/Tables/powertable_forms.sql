CREATE TABLE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[powertable_forms]([recordGuid] ASC);
