      ...
      CREATE   PROCEDURE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[ib_query_writeback] qw
