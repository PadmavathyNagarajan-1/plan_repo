        ...
        CREATE   PROCEDURE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [ede3309b-972b-4b4a-a429-3b1fa37cf58a].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [ede3309b-972b-4b4a-a429-3b1fa37cf58a].' + QUOTENAME(@DIVTableName) + ' AS div
