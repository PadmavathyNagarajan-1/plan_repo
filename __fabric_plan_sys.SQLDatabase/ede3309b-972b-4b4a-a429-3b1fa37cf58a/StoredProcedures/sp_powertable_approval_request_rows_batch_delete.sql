              ...
              CREATE PROCEDURE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [ede3309b-972b-4b4a-a429-3b1fa37cf58a].powertable_approval_request_rows SET status = 500 FROM [ede3309b-972b-4b4a-a429-3b1fa37cf58a].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
