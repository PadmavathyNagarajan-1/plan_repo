CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_transformation_steps]([recordGuid] ASC);
