CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_automation_jobs] ([id])
);
