CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_automation]([recordGuid] ASC);
