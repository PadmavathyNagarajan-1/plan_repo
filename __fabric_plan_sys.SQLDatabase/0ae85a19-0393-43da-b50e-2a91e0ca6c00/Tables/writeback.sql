CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[visual] ([id])
);
