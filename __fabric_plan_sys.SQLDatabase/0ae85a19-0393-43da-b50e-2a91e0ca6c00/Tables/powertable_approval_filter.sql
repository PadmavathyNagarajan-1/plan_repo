CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_filter]([recordGuid] ASC);
