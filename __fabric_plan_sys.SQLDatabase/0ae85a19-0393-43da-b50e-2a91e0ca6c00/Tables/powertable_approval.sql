CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval]([recordGuid] ASC);
