CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback_destination]([recordGuid] ASC);
