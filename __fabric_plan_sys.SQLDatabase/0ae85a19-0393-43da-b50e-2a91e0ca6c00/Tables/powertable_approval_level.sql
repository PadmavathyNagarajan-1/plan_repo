CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_level]([recordGuid] ASC);
