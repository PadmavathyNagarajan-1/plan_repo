CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback_settings]([recordGuid] ASC);
