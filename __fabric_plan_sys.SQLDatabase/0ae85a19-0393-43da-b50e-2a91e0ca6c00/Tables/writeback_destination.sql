CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[visual] ([id])
);
