CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_lookup_config]([recordGuid] ASC);
