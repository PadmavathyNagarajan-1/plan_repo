CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[writeback_settings]([recordGuid] ASC);
