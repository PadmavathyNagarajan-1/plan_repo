CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_forms]([recordGuid] ASC);
