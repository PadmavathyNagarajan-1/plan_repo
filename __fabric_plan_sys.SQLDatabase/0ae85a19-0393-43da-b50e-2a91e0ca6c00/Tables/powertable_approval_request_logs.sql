CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_request] ([id])
);
