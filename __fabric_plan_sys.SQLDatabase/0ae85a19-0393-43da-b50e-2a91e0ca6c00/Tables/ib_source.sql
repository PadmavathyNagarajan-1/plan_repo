CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_source]([recordGuid] ASC);
