CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[visual] ([id]) ON DELETE CASCADE
);
