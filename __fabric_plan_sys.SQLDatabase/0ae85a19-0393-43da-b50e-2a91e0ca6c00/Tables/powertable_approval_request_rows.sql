CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_approval_request] ([id])
);
