CREATE TABLE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[powertable_row_access_filters]([recordGuid] ASC);
