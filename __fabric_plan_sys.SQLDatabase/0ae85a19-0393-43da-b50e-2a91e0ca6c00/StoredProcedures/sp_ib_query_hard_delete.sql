      ...
      CREATE   PROCEDURE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[ib_query_writeback] qw
