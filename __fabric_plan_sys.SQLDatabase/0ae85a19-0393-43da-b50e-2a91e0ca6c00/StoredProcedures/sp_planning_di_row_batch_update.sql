            ...
            CREATE PROCEDURE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [0ae85a19-0393-43da-b50e-2a91e0ca6c00].data_input_row
                INNER JOIN [0ae85a19-0393-43da-b50e-2a91e0ca6c00].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
