                          ...
                          CREATE PROCEDURE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [0ae85a19-0393-43da-b50e-2a91e0ca6c00].powertable_approval_request_rows
