              ...
              CREATE PROCEDURE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [0ae85a19-0393-43da-b50e-2a91e0ca6c00].powertable_approval_request_rows SET status = 500 FROM [0ae85a19-0393-43da-b50e-2a91e0ca6c00].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
