                          ...
                          CREATE PROCEDURE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].powertable_approval_request_rows
