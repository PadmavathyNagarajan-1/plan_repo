            ...
            CREATE PROCEDURE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].data_input_row
                INNER JOIN [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
