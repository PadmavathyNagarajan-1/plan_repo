CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback_destination]([recordGuid] ASC);
