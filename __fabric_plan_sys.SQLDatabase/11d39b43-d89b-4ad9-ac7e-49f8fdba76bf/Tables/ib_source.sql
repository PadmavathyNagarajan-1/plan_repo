CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_source]([recordGuid] ASC);
