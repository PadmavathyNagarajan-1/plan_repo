CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_column_config]([recordGuid] ASC);
