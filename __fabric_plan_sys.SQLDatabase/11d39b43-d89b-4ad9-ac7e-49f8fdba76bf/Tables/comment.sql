CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[visual] ([id]) ON DELETE CASCADE
);
