CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_source] ([id])
);
