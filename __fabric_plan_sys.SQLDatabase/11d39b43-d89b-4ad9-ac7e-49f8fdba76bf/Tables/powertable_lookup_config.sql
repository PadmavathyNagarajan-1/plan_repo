CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_lookup_config]([recordGuid] ASC);
