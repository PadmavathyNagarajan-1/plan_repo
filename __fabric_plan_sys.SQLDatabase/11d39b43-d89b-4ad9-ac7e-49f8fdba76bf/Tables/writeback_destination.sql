CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[visual] ([id])
);
