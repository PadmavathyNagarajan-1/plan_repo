CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_transformation_steps]([recordGuid] ASC);
