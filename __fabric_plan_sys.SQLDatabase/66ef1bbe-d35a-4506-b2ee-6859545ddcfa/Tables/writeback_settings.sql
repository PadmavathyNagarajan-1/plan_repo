CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[writeback_settings]([recordGuid] ASC);
