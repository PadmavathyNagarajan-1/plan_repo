CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[visual] ([id]) ON DELETE CASCADE
);
