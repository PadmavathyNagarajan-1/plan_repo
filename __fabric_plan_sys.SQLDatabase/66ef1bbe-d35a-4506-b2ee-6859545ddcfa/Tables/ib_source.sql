CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_source]([recordGuid] ASC);
