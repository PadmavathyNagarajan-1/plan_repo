CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback_settings]([recordGuid] ASC);
