CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_request] ([id])
);
