CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback_destination]([recordGuid] ASC);
