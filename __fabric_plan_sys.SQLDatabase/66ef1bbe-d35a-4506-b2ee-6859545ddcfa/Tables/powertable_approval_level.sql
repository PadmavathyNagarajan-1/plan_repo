CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_level]([recordGuid] ASC);
