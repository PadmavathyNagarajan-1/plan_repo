CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_filter]([recordGuid] ASC);
