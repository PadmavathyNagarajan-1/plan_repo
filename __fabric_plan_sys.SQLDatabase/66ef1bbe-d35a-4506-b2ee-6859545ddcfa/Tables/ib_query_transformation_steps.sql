CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_transformation_steps]([recordGuid] ASC);
