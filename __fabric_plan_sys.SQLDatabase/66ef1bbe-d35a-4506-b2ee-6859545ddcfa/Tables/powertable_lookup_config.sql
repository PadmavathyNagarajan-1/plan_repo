CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_lookup_config]([recordGuid] ASC);
