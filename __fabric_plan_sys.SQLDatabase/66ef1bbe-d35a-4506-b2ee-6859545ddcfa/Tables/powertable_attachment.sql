CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_source] ([id])
);
