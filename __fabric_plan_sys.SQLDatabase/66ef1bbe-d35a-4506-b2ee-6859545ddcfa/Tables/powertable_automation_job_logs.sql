CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_automation_jobs] ([id])
);
