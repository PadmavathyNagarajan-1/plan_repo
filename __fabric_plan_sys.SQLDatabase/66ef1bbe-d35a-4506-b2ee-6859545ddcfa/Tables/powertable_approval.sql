CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval]([recordGuid] ASC);
