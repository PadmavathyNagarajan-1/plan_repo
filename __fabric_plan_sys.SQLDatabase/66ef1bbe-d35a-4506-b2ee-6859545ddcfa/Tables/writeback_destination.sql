CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[visual] ([id])
);
