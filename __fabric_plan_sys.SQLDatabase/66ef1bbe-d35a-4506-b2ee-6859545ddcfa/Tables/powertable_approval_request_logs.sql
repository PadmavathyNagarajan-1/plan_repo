CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_approval_request] ([id])
);
