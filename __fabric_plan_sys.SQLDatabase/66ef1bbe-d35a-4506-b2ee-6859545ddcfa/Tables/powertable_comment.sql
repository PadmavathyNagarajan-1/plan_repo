CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_source] ([id])
);
