CREATE TABLE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[powertable_automation]([recordGuid] ASC);
