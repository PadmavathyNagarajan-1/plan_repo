      ...
      CREATE   PROCEDURE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[ib_query_writeback] qw
