        ...
        CREATE   PROCEDURE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].' + QUOTENAME(@DIVTableName) + ' AS div
