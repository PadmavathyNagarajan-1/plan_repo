              ...
              CREATE PROCEDURE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].powertable_approval_request_rows SET status = 500 FROM [66ef1bbe-d35a-4506-b2ee-6859545ddcfa].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
