              ...
              CREATE PROCEDURE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].powertable_approval_request_rows SET status = 500 FROM [e8a37991-8bb4-402a-ae08-ddfd255e5f19].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
