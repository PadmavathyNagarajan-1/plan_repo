      ...
      CREATE   PROCEDURE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback] qw
