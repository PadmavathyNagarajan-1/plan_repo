            ...
            CREATE PROCEDURE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [e8a37991-8bb4-402a-ae08-ddfd255e5f19].data_input_row
                INNER JOIN [e8a37991-8bb4-402a-ae08-ddfd255e5f19].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
