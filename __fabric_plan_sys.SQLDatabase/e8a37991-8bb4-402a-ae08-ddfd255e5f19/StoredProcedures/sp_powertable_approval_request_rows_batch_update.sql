                          ...
                          CREATE PROCEDURE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [e8a37991-8bb4-402a-ae08-ddfd255e5f19].powertable_approval_request_rows
