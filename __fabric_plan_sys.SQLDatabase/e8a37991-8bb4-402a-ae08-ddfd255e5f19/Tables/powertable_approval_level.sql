CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval_level]([recordGuid] ASC);
