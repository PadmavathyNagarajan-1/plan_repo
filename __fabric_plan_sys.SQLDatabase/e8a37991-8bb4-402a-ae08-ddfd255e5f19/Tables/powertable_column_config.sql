CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_column_config]([recordGuid] ASC);
