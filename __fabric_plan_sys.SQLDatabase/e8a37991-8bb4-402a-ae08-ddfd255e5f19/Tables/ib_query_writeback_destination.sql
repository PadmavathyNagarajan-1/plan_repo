CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback_destination]([recordGuid] ASC);
