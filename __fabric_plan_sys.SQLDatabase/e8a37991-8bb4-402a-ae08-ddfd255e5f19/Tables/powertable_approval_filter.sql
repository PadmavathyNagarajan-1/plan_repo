CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval_filter]([recordGuid] ASC);
