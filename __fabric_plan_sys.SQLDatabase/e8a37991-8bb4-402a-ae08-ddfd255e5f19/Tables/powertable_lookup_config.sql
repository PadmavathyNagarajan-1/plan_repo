CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_lookup_config]([recordGuid] ASC);
