CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_source] ([id])
);
