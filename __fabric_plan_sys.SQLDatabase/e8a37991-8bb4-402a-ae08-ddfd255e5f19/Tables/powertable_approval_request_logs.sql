CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval_request] ([id])
);
