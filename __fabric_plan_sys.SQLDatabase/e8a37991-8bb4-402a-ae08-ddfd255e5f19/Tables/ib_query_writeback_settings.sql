CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_writeback_settings]([recordGuid] ASC);
