CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_approval]([recordGuid] ASC);
