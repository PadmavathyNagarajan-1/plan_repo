CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_row_access_filters]([recordGuid] ASC);
