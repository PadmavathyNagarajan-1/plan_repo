CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_source]([recordGuid] ASC);
