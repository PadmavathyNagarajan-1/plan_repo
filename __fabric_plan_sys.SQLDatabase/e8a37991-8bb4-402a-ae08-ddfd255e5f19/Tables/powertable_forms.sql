CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_forms]([recordGuid] ASC);
