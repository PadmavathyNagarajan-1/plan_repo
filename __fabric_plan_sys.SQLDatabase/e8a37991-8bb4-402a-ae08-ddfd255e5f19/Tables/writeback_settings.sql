CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[writeback_settings]([recordGuid] ASC);
