CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[ib_query_transformation_steps]([recordGuid] ASC);
