CREATE TABLE [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [e8a37991-8bb4-402a-ae08-ddfd255e5f19].[powertable_automation_jobs] ([id])
);
