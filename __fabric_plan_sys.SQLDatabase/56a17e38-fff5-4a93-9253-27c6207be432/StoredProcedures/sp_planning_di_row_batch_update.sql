            ...
            CREATE PROCEDURE [56a17e38-fff5-4a93-9253-27c6207be432].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [56a17e38-fff5-4a93-9253-27c6207be432].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [56a17e38-fff5-4a93-9253-27c6207be432].data_input_row
                INNER JOIN [56a17e38-fff5-4a93-9253-27c6207be432].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
