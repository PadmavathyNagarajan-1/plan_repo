CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_writeback_destination]([recordGuid] ASC);
