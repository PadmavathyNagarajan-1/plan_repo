CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_request] ([id])
);
