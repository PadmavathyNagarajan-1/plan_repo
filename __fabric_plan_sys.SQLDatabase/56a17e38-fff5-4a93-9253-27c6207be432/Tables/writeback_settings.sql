CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[writeback_settings]([recordGuid] ASC);
