CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_column_config]([recordGuid] ASC);
