CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_request] ([id])
);
