CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_row_access_filters]([recordGuid] ASC);
