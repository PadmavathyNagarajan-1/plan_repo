CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_automation_jobs] ([id])
);
