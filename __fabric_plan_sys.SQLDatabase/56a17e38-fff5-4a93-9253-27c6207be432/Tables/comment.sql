CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[visual] ([id]) ON DELETE CASCADE
);
