CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_source]([recordGuid] ASC);
