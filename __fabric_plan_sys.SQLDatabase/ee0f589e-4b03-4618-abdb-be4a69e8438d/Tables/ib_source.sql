CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_source]([recordGuid] ASC);
