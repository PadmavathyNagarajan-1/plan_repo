CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source_settings]([recordGuid] ASC);
