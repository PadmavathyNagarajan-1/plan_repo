CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval]([recordGuid] ASC);
