CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval_level]([recordGuid] ASC);
