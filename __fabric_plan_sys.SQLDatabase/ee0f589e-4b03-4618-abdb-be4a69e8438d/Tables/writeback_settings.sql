CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[writeback_settings]([recordGuid] ASC);
