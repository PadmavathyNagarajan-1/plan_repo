CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_transformation_steps]([recordGuid] ASC);
