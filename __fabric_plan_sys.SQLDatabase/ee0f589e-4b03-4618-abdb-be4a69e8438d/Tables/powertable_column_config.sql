CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_column_config]([recordGuid] ASC);
