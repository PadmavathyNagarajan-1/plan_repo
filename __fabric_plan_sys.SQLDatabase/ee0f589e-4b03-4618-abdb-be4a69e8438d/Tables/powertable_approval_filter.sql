CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval_filter]([recordGuid] ASC);
