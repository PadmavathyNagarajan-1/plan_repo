CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[visual] ([id])
);
