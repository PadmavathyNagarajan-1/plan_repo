CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[visual] ([id]) ON DELETE CASCADE
);
