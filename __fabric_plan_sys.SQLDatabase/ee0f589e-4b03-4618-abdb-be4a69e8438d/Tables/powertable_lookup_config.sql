CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_lookup_config]([recordGuid] ASC);
