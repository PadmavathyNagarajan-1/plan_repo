CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_approval_request] ([id])
);
