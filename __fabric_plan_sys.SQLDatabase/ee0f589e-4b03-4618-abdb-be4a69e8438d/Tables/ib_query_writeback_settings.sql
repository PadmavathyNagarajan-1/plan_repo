CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_writeback_settings]([recordGuid] ASC);
