CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_automation]([recordGuid] ASC);
