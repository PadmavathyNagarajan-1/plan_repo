CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_forms]([recordGuid] ASC);
