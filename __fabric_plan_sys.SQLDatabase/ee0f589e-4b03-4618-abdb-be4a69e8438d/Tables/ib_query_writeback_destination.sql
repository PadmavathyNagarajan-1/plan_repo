CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [ee0f589e-4b03-4618-abdb-be4a69e8438d].[ib_query_writeback_destination]([recordGuid] ASC);
