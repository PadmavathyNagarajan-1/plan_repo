CREATE TABLE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [ee0f589e-4b03-4618-abdb-be4a69e8438d].[powertable_automation_jobs] ([id])
);
