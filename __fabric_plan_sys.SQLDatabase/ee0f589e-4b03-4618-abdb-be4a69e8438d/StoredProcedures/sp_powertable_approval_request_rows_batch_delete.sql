              ...
              CREATE PROCEDURE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [ee0f589e-4b03-4618-abdb-be4a69e8438d].powertable_approval_request_rows SET status = 500 FROM [ee0f589e-4b03-4618-abdb-be4a69e8438d].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
