                          ...
                          CREATE PROCEDURE [ee0f589e-4b03-4618-abdb-be4a69e8438d].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [ee0f589e-4b03-4618-abdb-be4a69e8438d].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [ee0f589e-4b03-4618-abdb-be4a69e8438d].powertable_approval_request_rows
