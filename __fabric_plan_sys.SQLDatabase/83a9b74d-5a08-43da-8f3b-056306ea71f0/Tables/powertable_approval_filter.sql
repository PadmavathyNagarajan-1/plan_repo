CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_filter]([recordGuid] ASC);
