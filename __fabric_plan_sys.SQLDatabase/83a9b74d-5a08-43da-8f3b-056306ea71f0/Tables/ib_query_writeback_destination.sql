CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback_destination]([recordGuid] ASC);
