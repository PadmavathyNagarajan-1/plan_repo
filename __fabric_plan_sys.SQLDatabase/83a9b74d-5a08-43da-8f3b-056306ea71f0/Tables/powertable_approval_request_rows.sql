CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_request] ([id])
);
