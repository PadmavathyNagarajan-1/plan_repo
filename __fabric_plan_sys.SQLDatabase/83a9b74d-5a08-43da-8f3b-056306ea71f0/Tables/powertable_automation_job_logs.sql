CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_automation_jobs] ([id])
);
