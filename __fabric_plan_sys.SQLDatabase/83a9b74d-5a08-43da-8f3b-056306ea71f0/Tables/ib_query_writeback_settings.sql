CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback_settings]([recordGuid] ASC);
