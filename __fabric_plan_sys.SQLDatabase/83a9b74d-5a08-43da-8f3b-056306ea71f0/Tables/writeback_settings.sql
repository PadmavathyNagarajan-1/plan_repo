CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[writeback_settings]([recordGuid] ASC);
