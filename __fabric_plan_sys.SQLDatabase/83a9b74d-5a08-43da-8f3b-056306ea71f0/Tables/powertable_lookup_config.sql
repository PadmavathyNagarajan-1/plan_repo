CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_lookup_config]([recordGuid] ASC);
