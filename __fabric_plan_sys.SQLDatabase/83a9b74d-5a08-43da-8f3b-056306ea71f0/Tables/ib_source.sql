CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_source]([recordGuid] ASC);
