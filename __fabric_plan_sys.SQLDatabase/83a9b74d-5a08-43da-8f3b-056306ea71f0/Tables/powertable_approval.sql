CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval]([recordGuid] ASC);
