CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_forms]([recordGuid] ASC);
