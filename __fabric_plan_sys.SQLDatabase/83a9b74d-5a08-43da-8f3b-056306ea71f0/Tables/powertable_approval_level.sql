CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_level]([recordGuid] ASC);
