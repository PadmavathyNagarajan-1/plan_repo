CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_column_config]([recordGuid] ASC);
