CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_approval_request] ([id])
);
