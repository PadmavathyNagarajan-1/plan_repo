CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source_settings]([recordGuid] ASC);
