CREATE TABLE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [83a9b74d-5a08-43da-8f3b-056306ea71f0].[powertable_row_access_filters]([recordGuid] ASC);
