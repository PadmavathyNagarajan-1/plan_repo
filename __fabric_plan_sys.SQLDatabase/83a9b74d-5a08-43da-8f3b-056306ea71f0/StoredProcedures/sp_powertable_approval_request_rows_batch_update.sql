                          ...
                          CREATE PROCEDURE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [83a9b74d-5a08-43da-8f3b-056306ea71f0].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [83a9b74d-5a08-43da-8f3b-056306ea71f0].powertable_approval_request_rows
