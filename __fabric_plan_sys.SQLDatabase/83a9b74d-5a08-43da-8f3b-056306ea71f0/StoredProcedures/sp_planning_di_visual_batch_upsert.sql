        ...
        CREATE   PROCEDURE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [83a9b74d-5a08-43da-8f3b-056306ea71f0].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [83a9b74d-5a08-43da-8f3b-056306ea71f0].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [83a9b74d-5a08-43da-8f3b-056306ea71f0].' + QUOTENAME(@DIVTableName) + ' AS div
