              ...
              CREATE PROCEDURE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [83a9b74d-5a08-43da-8f3b-056306ea71f0].powertable_approval_request_rows SET status = 500 FROM [83a9b74d-5a08-43da-8f3b-056306ea71f0].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
