      ...
      CREATE   PROCEDURE [83a9b74d-5a08-43da-8f3b-056306ea71f0].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [83a9b74d-5a08-43da-8f3b-056306ea71f0].[ib_query_writeback] qw
