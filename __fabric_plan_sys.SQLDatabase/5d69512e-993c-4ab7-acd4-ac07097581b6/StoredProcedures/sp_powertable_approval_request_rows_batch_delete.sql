              ...
              CREATE PROCEDURE [5d69512e-993c-4ab7-acd4-ac07097581b6].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [5d69512e-993c-4ab7-acd4-ac07097581b6].powertable_approval_request_rows SET status = 500 FROM [5d69512e-993c-4ab7-acd4-ac07097581b6].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
