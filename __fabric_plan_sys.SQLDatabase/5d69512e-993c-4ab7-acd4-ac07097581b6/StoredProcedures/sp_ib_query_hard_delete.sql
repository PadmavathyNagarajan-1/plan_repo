      ...
      CREATE   PROCEDURE [5d69512e-993c-4ab7-acd4-ac07097581b6].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5d69512e-993c-4ab7-acd4-ac07097581b6].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5d69512e-993c-4ab7-acd4-ac07097581b6].[ib_query_writeback] qw
