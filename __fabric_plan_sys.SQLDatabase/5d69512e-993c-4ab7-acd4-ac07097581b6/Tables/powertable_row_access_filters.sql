CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_row_access_filters]([recordGuid] ASC);
