CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_lookup_config]([recordGuid] ASC);
