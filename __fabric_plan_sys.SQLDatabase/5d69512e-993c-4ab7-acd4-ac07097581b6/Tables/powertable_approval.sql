CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval]([recordGuid] ASC);
