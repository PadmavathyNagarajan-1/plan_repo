CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_request] ([id])
);
