CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_request] ([id])
);
