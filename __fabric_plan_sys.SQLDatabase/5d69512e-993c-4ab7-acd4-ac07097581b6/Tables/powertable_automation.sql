CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_automation]([recordGuid] ASC);
