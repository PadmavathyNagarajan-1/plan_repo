CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_column_config]([recordGuid] ASC);
