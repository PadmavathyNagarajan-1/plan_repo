CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_source_settings]([recordGuid] ASC);
