CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[visual] ([id]) ON DELETE CASCADE
);
