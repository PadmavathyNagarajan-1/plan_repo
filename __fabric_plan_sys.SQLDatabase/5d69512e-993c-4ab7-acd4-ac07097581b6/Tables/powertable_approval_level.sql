CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_level]([recordGuid] ASC);
