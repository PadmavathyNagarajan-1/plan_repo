CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_approval_filter]([recordGuid] ASC);
