CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[powertable_automation_jobs] ([id])
);
