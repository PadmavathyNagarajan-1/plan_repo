CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[ib_query_writeback_settings]([recordGuid] ASC);
