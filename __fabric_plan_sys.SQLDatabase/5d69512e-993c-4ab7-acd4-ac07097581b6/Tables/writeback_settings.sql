CREATE TABLE [5d69512e-993c-4ab7-acd4-ac07097581b6].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5d69512e-993c-4ab7-acd4-ac07097581b6].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5d69512e-993c-4ab7-acd4-ac07097581b6].[writeback_settings]([recordGuid] ASC);
