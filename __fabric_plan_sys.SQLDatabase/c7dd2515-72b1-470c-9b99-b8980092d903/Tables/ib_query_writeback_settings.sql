CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_writeback_settings]([recordGuid] ASC);
