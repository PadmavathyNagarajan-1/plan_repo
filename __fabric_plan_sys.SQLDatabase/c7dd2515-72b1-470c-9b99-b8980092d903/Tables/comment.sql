CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[visual] ([id]) ON DELETE CASCADE
);
