CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval]([recordGuid] ASC);
