CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_level]([recordGuid] ASC);
