CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_request] ([id])
);
