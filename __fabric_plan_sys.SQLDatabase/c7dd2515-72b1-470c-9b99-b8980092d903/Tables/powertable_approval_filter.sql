CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_filter]([recordGuid] ASC);
