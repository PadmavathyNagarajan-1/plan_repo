CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_column_config]([recordGuid] ASC);
