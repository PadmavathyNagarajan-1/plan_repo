CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_writeback_destination]([recordGuid] ASC);
