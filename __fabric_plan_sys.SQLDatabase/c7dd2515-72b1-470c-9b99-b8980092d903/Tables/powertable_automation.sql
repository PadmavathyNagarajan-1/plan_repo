CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_automation]([recordGuid] ASC);
