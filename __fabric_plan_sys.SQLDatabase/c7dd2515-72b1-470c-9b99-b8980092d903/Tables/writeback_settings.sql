CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[writeback_settings]([recordGuid] ASC);
