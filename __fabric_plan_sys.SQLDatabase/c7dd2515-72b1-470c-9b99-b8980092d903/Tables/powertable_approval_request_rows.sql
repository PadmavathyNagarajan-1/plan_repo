CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_approval_request] ([id])
);
