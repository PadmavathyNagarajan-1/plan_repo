CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_automation_jobs] ([id])
);
