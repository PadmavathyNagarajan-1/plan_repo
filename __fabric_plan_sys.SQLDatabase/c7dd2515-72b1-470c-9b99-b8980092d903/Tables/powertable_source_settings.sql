CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source_settings]([recordGuid] ASC);
