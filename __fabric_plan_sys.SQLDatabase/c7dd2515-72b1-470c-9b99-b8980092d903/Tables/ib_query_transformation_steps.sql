CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_query_transformation_steps]([recordGuid] ASC);
