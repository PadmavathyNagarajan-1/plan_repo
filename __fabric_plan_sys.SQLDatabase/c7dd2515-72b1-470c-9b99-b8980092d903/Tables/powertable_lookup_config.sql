CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[powertable_lookup_config]([recordGuid] ASC);
