CREATE TABLE [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [c7dd2515-72b1-470c-9b99-b8980092d903].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [c7dd2515-72b1-470c-9b99-b8980092d903].[ib_source]([recordGuid] ASC);
