              ...
              CREATE PROCEDURE [c7dd2515-72b1-470c-9b99-b8980092d903].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [c7dd2515-72b1-470c-9b99-b8980092d903].powertable_approval_request_rows SET status = 500 FROM [c7dd2515-72b1-470c-9b99-b8980092d903].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
