      ...
      CREATE   PROCEDURE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_query_writeback] qw
