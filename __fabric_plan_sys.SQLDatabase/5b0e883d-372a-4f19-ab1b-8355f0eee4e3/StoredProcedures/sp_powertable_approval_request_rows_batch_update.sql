                          ...
                          CREATE PROCEDURE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].powertable_approval_request_rows
