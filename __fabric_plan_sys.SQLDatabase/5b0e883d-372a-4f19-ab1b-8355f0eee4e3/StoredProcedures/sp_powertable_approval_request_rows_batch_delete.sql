              ...
              CREATE PROCEDURE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].powertable_approval_request_rows SET status = 500 FROM [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
