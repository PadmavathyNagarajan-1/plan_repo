        ...
        CREATE   PROCEDURE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].' + QUOTENAME(@DIVTableName) + ' AS div
