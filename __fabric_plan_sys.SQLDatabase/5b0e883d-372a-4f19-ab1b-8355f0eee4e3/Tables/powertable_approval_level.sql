CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_level]([recordGuid] ASC);
