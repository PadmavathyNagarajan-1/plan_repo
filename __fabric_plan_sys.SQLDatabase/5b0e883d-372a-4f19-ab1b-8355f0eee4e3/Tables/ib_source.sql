CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_source]([recordGuid] ASC);
