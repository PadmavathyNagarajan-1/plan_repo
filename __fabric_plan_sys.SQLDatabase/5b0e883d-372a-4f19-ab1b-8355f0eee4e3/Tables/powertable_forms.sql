CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_forms]([recordGuid] ASC);
