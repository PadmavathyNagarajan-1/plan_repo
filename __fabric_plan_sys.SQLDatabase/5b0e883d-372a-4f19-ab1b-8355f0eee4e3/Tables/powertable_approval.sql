CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval]([recordGuid] ASC);
