CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_automation_jobs] ([id])
);
