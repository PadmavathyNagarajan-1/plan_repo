CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[writeback_settings]([recordGuid] ASC);
