CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_row_access_filters]([recordGuid] ASC);
