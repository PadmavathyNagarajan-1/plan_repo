CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_filter]([recordGuid] ASC);
