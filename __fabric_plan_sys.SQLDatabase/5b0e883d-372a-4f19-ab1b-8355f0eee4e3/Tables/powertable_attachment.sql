CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_source] ([id])
);
