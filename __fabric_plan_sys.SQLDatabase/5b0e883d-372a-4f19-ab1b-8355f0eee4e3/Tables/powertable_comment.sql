CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_source] ([id])
);
