CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_request] ([id])
);
