CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[visual] ([id]) ON DELETE CASCADE
);
