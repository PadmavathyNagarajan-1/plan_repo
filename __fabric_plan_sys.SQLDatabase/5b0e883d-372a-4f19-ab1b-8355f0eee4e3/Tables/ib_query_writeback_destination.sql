CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[ib_query_writeback_destination]([recordGuid] ASC);
