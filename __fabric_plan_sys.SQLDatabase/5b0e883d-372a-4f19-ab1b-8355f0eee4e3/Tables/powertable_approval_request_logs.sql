CREATE TABLE [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5b0e883d-372a-4f19-ab1b-8355f0eee4e3].[powertable_approval_request] ([id])
);
