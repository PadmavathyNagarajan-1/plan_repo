CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[visual] ([id]) ON DELETE CASCADE
);
