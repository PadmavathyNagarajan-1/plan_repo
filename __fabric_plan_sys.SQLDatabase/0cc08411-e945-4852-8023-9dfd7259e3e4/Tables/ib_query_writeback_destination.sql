CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_query_writeback_destination]([recordGuid] ASC);
