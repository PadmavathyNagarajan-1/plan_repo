CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_row_access_filters]([recordGuid] ASC);
