CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_level]([recordGuid] ASC);
