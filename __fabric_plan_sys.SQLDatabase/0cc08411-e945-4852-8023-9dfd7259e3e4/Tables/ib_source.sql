CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_source]([recordGuid] ASC);
