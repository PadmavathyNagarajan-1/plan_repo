CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source_settings]([recordGuid] ASC);
