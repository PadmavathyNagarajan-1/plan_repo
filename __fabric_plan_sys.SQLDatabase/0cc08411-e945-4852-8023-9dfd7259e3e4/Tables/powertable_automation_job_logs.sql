CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_automation_jobs] ([id])
);
