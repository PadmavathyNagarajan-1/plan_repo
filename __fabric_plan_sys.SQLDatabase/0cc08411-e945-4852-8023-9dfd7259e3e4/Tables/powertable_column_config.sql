CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_column_config]([recordGuid] ASC);
