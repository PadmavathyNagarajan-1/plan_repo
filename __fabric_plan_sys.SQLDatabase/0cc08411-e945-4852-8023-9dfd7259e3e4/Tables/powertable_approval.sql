CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval]([recordGuid] ASC);
