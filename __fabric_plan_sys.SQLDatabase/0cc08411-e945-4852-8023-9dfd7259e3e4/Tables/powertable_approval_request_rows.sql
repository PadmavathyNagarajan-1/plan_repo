CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_request] ([id])
);
