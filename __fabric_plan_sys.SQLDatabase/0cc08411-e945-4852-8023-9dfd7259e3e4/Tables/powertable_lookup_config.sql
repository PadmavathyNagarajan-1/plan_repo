CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_lookup_config]([recordGuid] ASC);
