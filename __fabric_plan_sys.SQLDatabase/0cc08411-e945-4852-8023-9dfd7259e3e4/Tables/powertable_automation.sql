CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_automation]([recordGuid] ASC);
