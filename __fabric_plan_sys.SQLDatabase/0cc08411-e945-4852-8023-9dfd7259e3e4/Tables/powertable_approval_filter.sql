CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_filter]([recordGuid] ASC);
