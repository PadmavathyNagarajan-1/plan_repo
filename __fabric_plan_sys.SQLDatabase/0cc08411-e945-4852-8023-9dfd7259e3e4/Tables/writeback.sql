CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[visual] ([id])
);
