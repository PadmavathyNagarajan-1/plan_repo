CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[ib_query_writeback_settings]([recordGuid] ASC);
