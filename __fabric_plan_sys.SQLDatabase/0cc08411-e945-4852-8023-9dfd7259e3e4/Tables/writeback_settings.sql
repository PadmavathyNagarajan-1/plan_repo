CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [0cc08411-e945-4852-8023-9dfd7259e3e4].[writeback_settings]([recordGuid] ASC);
