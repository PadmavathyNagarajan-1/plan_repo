CREATE TABLE [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [0cc08411-e945-4852-8023-9dfd7259e3e4].[powertable_approval_request] ([id])
);
