              ...
              CREATE PROCEDURE [fed43777-c838-408e-9a33-4b235efc9808].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [fed43777-c838-408e-9a33-4b235efc9808].powertable_approval_request_rows SET status = 500 FROM [fed43777-c838-408e-9a33-4b235efc9808].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
