CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_request] ([id])
);
