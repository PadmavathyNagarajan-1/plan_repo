CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[visual] ([id]) ON DELETE CASCADE
);
