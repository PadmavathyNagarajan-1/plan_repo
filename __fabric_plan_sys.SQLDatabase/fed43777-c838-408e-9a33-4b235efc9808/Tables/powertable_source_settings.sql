CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source_settings]([recordGuid] ASC);
