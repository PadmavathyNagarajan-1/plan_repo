CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_automation_jobs] ([id])
);
