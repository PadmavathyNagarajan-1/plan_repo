CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_transformation_steps]([recordGuid] ASC);
