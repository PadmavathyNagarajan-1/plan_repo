CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[writeback_settings]([recordGuid] ASC);
