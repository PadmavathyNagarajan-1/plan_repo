CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_forms]([recordGuid] ASC);
