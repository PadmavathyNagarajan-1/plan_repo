CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_writeback_settings]([recordGuid] ASC);
