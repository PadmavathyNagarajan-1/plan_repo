CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_row_access_filters]([recordGuid] ASC);
