CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_lookup_config]([recordGuid] ASC);
