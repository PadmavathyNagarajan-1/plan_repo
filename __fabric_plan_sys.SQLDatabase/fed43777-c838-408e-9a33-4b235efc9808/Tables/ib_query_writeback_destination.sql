CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[ib_query_writeback_destination]([recordGuid] ASC);
