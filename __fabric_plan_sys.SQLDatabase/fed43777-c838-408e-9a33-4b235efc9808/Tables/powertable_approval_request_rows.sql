CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_request] ([id])
);
