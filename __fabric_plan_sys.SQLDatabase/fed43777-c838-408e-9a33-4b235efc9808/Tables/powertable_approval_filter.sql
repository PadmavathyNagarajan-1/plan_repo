CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_filter]([recordGuid] ASC);
