CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[visual] ([id])
);
