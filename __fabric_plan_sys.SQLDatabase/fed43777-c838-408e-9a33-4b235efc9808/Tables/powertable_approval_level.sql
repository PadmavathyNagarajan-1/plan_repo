CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_approval_level]([recordGuid] ASC);
