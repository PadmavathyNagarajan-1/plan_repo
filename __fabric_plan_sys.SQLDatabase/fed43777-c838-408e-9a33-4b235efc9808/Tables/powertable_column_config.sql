CREATE TABLE [fed43777-c838-408e-9a33-4b235efc9808].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [fed43777-c838-408e-9a33-4b235efc9808].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [fed43777-c838-408e-9a33-4b235efc9808].[powertable_column_config]([recordGuid] ASC);
