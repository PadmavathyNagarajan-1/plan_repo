      ...
      CREATE   PROCEDURE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback] qw
