        ...
        CREATE   PROCEDURE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [725e6b4a-2ab0-41b1-9239-3e6f418666bc].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [725e6b4a-2ab0-41b1-9239-3e6f418666bc].' + QUOTENAME(@DIVTableName) + ' AS div
