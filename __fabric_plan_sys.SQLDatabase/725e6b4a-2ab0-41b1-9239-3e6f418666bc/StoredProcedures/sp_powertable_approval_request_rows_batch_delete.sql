              ...
              CREATE PROCEDURE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].powertable_approval_request_rows SET status = 500 FROM [725e6b4a-2ab0-41b1-9239-3e6f418666bc].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
