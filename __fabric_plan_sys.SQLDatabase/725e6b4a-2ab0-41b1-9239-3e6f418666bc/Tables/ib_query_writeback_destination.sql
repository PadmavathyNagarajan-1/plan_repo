CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback_destination]([recordGuid] ASC);
