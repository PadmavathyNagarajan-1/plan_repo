CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_automation_jobs] ([id])
);
