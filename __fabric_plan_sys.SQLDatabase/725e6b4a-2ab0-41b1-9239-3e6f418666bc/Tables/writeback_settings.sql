CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[writeback_settings]([recordGuid] ASC);
