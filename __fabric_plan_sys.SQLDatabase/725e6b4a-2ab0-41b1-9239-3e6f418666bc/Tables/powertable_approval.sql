CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval]([recordGuid] ASC);
