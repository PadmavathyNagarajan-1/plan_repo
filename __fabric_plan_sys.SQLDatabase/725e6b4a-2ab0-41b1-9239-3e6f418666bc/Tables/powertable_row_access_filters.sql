CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_row_access_filters]([recordGuid] ASC);
