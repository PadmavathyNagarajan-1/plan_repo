CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_lookup_config]([recordGuid] ASC);
