CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval_level]([recordGuid] ASC);
