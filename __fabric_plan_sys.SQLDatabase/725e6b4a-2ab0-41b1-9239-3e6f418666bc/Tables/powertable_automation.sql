CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_automation]([recordGuid] ASC);
