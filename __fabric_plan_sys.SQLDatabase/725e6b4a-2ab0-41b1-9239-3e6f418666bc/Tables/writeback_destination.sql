CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[visual] ([id])
);
