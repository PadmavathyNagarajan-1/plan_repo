CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval_filter]([recordGuid] ASC);
