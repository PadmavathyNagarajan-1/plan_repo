CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_writeback_settings]([recordGuid] ASC);
