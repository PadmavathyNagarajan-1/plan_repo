CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_column_config]([recordGuid] ASC);
