CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_approval_request] ([id])
);
