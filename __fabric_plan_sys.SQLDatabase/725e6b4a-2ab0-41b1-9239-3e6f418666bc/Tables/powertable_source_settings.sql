CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[powertable_source_settings]([recordGuid] ASC);
