CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[visual] ([id]) ON DELETE CASCADE
);
