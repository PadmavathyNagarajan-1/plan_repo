CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_query_transformation_steps]([recordGuid] ASC);
