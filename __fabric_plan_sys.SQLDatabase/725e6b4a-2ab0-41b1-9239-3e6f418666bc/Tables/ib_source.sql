CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[ib_source]([recordGuid] ASC);
