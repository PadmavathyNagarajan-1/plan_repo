CREATE TABLE [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [725e6b4a-2ab0-41b1-9239-3e6f418666bc].[visual] ([id])
);
