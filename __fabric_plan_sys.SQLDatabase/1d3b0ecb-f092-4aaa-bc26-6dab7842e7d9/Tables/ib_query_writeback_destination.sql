CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback_destination]([recordGuid] ASC);
