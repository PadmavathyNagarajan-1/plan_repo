CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_automation_jobs] ([id])
);
