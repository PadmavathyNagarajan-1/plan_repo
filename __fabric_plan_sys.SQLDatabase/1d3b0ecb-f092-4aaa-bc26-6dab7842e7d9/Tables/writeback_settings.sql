CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[writeback_settings]([recordGuid] ASC);
