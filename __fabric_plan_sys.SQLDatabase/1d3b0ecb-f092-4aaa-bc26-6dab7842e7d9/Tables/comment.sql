CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[visual] ([id]) ON DELETE CASCADE
);
