CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback_settings]([recordGuid] ASC);
