CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_column_config]([recordGuid] ASC);
