CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_approval_filter]([recordGuid] ASC);
