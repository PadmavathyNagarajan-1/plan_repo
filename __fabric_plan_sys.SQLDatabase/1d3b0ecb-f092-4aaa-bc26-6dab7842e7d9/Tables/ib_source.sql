CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_source]([recordGuid] ASC);
