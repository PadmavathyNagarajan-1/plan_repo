CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_transformation_steps]([recordGuid] ASC);
