CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[visual] ([id])
);
