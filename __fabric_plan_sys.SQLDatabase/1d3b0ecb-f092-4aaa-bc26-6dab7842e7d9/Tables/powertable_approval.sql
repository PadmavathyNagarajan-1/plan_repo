CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_approval]([recordGuid] ASC);
