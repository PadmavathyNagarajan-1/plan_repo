CREATE TABLE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[powertable_lookup_config]([recordGuid] ASC);
