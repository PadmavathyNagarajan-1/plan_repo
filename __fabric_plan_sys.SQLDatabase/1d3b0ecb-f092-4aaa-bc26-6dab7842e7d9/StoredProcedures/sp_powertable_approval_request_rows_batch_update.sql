                          ...
                          CREATE PROCEDURE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].powertable_approval_request_rows
