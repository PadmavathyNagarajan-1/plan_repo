        ...
        CREATE   PROCEDURE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].' + QUOTENAME(@DIVTableName) + ' AS div
