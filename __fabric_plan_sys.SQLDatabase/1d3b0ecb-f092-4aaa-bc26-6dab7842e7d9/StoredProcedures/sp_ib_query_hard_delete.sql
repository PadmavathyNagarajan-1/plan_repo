      ...
      CREATE   PROCEDURE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[ib_query_writeback] qw
