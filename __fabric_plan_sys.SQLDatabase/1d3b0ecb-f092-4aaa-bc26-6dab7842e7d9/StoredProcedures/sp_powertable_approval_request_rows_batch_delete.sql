              ...
              CREATE PROCEDURE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].powertable_approval_request_rows SET status = 500 FROM [1d3b0ecb-f092-4aaa-bc26-6dab7842e7d9].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
