              ...
              CREATE PROCEDURE [0a30e004-fe75-4863-bd22-85da0214b4a8].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [0a30e004-fe75-4863-bd22-85da0214b4a8].powertable_approval_request_rows SET status = 500 FROM [0a30e004-fe75-4863-bd22-85da0214b4a8].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
