CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[writeback_settings]([recordGuid] ASC);
