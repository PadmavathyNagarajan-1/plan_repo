CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_source]([recordGuid] ASC);
