CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[visual] ([id])
);
