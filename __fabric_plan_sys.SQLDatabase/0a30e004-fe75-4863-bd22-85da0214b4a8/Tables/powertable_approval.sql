CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval]([recordGuid] ASC);
