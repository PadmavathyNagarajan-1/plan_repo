CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_automation_jobs] ([id])
);
