CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_query_writeback_destination]([recordGuid] ASC);
