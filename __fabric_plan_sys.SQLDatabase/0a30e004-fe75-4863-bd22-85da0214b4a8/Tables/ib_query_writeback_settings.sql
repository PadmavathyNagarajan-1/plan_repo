CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[ib_query_writeback_settings]([recordGuid] ASC);
