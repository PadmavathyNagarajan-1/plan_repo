CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_lookup_config]([recordGuid] ASC);
