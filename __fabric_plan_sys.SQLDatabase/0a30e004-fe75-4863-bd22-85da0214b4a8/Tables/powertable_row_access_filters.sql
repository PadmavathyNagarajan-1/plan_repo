CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_row_access_filters]([recordGuid] ASC);
