CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_level]([recordGuid] ASC);
