CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_column_config]([recordGuid] ASC);
