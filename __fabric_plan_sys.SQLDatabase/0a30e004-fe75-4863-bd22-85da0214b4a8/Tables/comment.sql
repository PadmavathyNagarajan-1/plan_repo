CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[visual] ([id]) ON DELETE CASCADE
);
