CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_filter]([recordGuid] ASC);
