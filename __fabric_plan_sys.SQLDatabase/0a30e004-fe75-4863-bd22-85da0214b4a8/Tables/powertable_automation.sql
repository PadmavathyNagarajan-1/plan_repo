CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_automation]([recordGuid] ASC);
