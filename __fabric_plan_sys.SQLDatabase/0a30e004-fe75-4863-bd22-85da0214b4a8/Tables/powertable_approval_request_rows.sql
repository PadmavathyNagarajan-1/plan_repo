CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_request] ([id])
);
