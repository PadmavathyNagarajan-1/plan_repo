CREATE TABLE [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [0a30e004-fe75-4863-bd22-85da0214b4a8].[powertable_approval_request] ([id])
);
