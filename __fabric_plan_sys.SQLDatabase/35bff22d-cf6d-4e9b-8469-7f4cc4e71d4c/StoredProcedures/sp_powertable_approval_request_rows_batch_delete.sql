              ...
              CREATE PROCEDURE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].powertable_approval_request_rows SET status = 500 FROM [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
