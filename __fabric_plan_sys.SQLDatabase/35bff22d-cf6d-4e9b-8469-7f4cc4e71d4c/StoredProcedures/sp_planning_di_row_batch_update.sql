            ...
            CREATE PROCEDURE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].data_input_row
                INNER JOIN [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
