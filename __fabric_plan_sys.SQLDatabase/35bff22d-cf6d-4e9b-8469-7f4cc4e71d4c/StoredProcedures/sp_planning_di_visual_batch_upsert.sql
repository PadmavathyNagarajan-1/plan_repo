        ...
        CREATE   PROCEDURE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].' + QUOTENAME(@DIVTableName) + ' AS div
