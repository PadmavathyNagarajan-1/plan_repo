      ...
      CREATE   PROCEDURE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback] qw
