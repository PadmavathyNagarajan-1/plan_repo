CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[visual] ([id])
);
