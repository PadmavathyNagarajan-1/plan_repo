CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[visual] ([id])
);
