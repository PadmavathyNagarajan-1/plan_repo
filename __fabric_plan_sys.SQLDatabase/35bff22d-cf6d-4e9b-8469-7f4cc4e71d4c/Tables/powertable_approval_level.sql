CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_approval_level]([recordGuid] ASC);
