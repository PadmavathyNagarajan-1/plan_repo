CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_source]([recordGuid] ASC);
