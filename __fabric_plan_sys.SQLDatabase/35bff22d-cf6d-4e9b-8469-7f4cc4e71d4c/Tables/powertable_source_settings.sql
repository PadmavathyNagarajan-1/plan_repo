CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_source_settings]([recordGuid] ASC);
