CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[visual] ([id]) ON DELETE CASCADE
);
