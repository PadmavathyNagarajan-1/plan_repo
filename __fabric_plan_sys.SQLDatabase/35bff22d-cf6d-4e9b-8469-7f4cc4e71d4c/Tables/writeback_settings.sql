CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[writeback_settings]([recordGuid] ASC);
