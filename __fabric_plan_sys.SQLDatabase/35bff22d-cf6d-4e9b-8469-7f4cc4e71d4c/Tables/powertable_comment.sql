CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[powertable_source] ([id])
);
