CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_transformation_steps]([recordGuid] ASC);
