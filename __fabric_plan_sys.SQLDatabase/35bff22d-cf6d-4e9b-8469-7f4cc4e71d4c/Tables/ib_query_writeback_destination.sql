CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback_destination]([recordGuid] ASC);
