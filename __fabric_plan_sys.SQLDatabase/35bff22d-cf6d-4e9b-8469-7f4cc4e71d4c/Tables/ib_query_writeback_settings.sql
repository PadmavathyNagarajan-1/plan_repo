CREATE TABLE [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [35bff22d-cf6d-4e9b-8469-7f4cc4e71d4c].[ib_query_writeback_settings]([recordGuid] ASC);
