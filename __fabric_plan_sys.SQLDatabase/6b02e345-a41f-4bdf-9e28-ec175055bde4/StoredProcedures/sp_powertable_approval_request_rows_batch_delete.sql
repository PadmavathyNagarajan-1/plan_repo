              ...
              CREATE PROCEDURE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [6b02e345-a41f-4bdf-9e28-ec175055bde4].powertable_approval_request_rows SET status = 500 FROM [6b02e345-a41f-4bdf-9e28-ec175055bde4].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
