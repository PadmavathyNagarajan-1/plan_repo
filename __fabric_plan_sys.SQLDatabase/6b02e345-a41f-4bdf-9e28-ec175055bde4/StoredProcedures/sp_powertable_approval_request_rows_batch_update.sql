                          ...
                          CREATE PROCEDURE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [6b02e345-a41f-4bdf-9e28-ec175055bde4].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [6b02e345-a41f-4bdf-9e28-ec175055bde4].powertable_approval_request_rows
