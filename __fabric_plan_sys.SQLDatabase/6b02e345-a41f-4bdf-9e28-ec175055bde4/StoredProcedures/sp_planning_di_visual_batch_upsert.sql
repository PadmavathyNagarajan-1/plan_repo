        ...
        CREATE   PROCEDURE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [6b02e345-a41f-4bdf-9e28-ec175055bde4].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [6b02e345-a41f-4bdf-9e28-ec175055bde4].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [6b02e345-a41f-4bdf-9e28-ec175055bde4].' + QUOTENAME(@DIVTableName) + ' AS div
