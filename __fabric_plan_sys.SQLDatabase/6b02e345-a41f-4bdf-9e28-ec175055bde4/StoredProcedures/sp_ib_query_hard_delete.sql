      ...
      CREATE   PROCEDURE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback] qw
