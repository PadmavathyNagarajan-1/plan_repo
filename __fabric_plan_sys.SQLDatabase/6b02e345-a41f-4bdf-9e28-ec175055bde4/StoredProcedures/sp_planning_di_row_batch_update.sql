            ...
            CREATE PROCEDURE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [6b02e345-a41f-4bdf-9e28-ec175055bde4].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [6b02e345-a41f-4bdf-9e28-ec175055bde4].data_input_row
                INNER JOIN [6b02e345-a41f-4bdf-9e28-ec175055bde4].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
