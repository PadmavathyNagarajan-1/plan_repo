CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback_destination]([recordGuid] ASC);
