CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_column_config]([recordGuid] ASC);
