CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[writeback_settings]([recordGuid] ASC);
