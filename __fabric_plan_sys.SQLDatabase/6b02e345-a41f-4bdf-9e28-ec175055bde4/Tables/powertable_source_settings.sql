CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source_settings]([recordGuid] ASC);
