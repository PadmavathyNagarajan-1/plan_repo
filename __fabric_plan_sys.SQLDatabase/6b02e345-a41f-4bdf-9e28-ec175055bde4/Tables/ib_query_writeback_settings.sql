CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_writeback_settings]([recordGuid] ASC);
