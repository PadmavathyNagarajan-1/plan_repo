CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_source]([recordGuid] ASC);
