CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_automation]([recordGuid] ASC);
