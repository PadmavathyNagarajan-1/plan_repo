CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[visual] ([id])
);
