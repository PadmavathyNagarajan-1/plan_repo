CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_level]([recordGuid] ASC);
