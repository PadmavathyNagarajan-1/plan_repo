CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_filter]([recordGuid] ASC);
