CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval]([recordGuid] ASC);
