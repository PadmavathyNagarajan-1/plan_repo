CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_lookup_config]([recordGuid] ASC);
