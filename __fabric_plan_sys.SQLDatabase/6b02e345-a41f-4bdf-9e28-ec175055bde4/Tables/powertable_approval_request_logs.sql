CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_request] ([id])
);
