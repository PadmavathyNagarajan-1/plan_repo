CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[visual] ([id]) ON DELETE CASCADE
);
