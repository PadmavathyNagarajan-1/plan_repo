CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_forms]([recordGuid] ASC);
