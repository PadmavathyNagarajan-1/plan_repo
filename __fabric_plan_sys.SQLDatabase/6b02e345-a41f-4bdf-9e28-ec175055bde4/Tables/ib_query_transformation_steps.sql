CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [6b02e345-a41f-4bdf-9e28-ec175055bde4].[ib_query_transformation_steps]([recordGuid] ASC);
