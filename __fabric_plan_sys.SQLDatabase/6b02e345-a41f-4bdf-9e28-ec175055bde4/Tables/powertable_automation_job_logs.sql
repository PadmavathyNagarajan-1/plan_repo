CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_automation_jobs] ([id])
);
