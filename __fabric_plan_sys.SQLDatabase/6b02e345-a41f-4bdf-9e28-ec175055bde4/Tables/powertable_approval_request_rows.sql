CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_approval_request] ([id])
);
