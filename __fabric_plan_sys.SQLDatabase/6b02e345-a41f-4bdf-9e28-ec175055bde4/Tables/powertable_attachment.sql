CREATE TABLE [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [6b02e345-a41f-4bdf-9e28-ec175055bde4].[powertable_source] ([id])
);
