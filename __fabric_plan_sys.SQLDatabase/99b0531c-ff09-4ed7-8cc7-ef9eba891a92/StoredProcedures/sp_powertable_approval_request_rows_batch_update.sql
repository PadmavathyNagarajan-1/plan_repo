                          ...
                          CREATE PROCEDURE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].powertable_approval_request_rows
