        ...
        CREATE   PROCEDURE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].' + QUOTENAME(@DIVTableName) + ' AS div
