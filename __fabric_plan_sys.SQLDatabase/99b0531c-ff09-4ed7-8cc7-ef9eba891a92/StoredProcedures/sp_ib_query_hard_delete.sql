      ...
      CREATE   PROCEDURE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback] qw
