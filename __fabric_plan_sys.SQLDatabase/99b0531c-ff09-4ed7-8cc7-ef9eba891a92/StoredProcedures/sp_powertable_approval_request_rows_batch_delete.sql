              ...
              CREATE PROCEDURE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].powertable_approval_request_rows SET status = 500 FROM [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
