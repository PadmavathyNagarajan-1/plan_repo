CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[writeback_settings]([recordGuid] ASC);
