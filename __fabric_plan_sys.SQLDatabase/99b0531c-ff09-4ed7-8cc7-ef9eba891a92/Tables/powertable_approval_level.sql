CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval_level]([recordGuid] ASC);
