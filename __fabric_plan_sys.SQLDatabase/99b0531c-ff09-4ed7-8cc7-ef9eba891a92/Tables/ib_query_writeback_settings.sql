CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback_settings]([recordGuid] ASC);
