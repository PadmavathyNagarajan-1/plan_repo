CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[visual] ([id]) ON DELETE CASCADE
);
