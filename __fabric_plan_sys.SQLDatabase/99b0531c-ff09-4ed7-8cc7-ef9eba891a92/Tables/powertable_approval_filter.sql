CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval_filter]([recordGuid] ASC);
