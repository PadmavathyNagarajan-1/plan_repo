CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_automation]([recordGuid] ASC);
