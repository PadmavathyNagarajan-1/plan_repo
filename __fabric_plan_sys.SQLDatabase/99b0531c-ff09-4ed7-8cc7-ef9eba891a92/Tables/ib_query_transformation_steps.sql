CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_transformation_steps]([recordGuid] ASC);
