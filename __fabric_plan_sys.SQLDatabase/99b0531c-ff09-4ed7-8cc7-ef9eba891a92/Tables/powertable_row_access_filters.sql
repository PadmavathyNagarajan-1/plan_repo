CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_row_access_filters]([recordGuid] ASC);
