CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_query_writeback_destination]([recordGuid] ASC);
