CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_attachment] (
    ...
    CONSTRAINT [FK_2bd05b1cc85a67483bedbced9c3] FOREIGN KEY ([sourceId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_source] ([id])
);
