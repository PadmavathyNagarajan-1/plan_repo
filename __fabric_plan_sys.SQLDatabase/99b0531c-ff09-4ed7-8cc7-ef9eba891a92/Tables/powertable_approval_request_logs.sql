CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_approval_request] ([id])
);
