CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_automation_jobs] ([id])
);
