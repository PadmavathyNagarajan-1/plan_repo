CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_lookup_config]([recordGuid] ASC);
