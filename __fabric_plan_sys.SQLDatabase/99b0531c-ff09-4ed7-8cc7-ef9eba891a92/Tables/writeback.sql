CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[visual] ([id])
);
