CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[ib_source]([recordGuid] ASC);
