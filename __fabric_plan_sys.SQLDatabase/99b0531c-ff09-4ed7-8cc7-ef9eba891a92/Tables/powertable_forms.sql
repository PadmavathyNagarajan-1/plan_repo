CREATE TABLE [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [99b0531c-ff09-4ed7-8cc7-ef9eba891a92].[powertable_forms]([recordGuid] ASC);
