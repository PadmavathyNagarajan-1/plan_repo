CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval_request] ([id])
);
