CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_automation]([recordGuid] ASC);
