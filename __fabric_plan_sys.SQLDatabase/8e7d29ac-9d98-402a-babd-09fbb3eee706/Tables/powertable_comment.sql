CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source] ([id])
);
