CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[writeback_settings]([recordGuid] ASC);
