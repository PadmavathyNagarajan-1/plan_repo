CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[visual] ([id]) ON DELETE CASCADE
);
