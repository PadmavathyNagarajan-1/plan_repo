CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_source]([recordGuid] ASC);
