CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_column_config]([recordGuid] ASC);
