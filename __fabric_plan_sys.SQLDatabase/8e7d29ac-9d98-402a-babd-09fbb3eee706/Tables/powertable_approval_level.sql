CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval_level]([recordGuid] ASC);
