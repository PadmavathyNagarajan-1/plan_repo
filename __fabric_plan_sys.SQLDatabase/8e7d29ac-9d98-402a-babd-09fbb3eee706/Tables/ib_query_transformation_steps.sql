CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_transformation_steps]([recordGuid] ASC);
