CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_approval]([recordGuid] ASC);
