CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback_destination]([recordGuid] ASC);
