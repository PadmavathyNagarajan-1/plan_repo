CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_row_access_filters]([recordGuid] ASC);
