CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_lookup_config]([recordGuid] ASC);
