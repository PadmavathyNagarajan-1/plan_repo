CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_automation_jobs] ([id])
);
