CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback_settings]([recordGuid] ASC);
