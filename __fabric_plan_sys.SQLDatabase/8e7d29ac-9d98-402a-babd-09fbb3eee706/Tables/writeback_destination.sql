CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[visual] ([id])
);
