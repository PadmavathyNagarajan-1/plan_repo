CREATE TABLE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [8e7d29ac-9d98-402a-babd-09fbb3eee706].[powertable_source_settings]([recordGuid] ASC);
