              ...
              CREATE PROCEDURE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [8e7d29ac-9d98-402a-babd-09fbb3eee706].powertable_approval_request_rows SET status = 500 FROM [8e7d29ac-9d98-402a-babd-09fbb3eee706].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
