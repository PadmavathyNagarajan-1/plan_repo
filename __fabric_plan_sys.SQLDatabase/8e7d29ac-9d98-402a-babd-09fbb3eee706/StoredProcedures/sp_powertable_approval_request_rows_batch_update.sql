                          ...
                          CREATE PROCEDURE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [8e7d29ac-9d98-402a-babd-09fbb3eee706].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [8e7d29ac-9d98-402a-babd-09fbb3eee706].powertable_approval_request_rows
