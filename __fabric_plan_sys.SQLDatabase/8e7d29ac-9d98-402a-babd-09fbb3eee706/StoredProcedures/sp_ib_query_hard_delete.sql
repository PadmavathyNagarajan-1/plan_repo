      ...
      CREATE   PROCEDURE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [8e7d29ac-9d98-402a-babd-09fbb3eee706].[ib_query_writeback] qw
