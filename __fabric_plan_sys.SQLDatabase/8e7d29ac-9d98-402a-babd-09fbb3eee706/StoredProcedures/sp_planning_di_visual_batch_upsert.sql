        ...
        CREATE   PROCEDURE [8e7d29ac-9d98-402a-babd-09fbb3eee706].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [8e7d29ac-9d98-402a-babd-09fbb3eee706].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [8e7d29ac-9d98-402a-babd-09fbb3eee706].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [8e7d29ac-9d98-402a-babd-09fbb3eee706].' + QUOTENAME(@DIVTableName) + ' AS div
