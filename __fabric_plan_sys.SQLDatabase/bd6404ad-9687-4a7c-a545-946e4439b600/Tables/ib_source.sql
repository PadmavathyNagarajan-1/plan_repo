CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_source]([recordGuid] ASC);
