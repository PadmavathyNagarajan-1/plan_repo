CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_lookup_config]([recordGuid] ASC);
