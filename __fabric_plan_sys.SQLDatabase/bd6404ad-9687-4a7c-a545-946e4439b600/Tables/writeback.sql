CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[visual] ([id])
);
