CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval]([recordGuid] ASC);
