CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_level]([recordGuid] ASC);
