CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[visual] ([id])
);
