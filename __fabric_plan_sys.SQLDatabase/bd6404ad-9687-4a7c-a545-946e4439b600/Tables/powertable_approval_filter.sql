CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_filter]([recordGuid] ASC);
