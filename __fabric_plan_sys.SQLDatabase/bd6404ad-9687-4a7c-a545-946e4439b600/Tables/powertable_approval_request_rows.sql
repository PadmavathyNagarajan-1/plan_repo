CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_request] ([id])
);
