CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_column_config]([recordGuid] ASC);
