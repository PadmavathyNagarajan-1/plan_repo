CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_writeback_settings]([recordGuid] ASC);
