CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_transformation_steps]([recordGuid] ASC);
