CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_row_access_filters]([recordGuid] ASC);
