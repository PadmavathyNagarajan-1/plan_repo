CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[visual] ([id]) ON DELETE CASCADE
);
