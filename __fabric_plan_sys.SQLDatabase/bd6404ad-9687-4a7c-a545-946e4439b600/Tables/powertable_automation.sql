CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_automation]([recordGuid] ASC);
