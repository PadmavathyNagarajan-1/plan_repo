CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_forms]([recordGuid] ASC);
