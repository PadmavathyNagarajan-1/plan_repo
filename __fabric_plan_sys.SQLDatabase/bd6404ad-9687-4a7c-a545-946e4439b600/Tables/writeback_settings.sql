CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[writeback_settings]([recordGuid] ASC);
