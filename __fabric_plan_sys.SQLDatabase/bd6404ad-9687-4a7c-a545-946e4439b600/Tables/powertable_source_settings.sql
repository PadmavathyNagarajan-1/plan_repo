CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_source_settings]([recordGuid] ASC);
