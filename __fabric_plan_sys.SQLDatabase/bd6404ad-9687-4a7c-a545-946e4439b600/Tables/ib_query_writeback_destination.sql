CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [bd6404ad-9687-4a7c-a545-946e4439b600].[ib_query_writeback_destination]([recordGuid] ASC);
