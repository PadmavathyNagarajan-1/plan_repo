CREATE TABLE [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [bd6404ad-9687-4a7c-a545-946e4439b600].[powertable_approval_request] ([id])
);
