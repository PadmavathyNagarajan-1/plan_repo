              ...
              CREATE PROCEDURE [bd6404ad-9687-4a7c-a545-946e4439b600].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [bd6404ad-9687-4a7c-a545-946e4439b600].powertable_approval_request_rows SET status = 500 FROM [bd6404ad-9687-4a7c-a545-946e4439b600].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
