            ...
            CREATE PROCEDURE [bd6404ad-9687-4a7c-a545-946e4439b600].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [bd6404ad-9687-4a7c-a545-946e4439b600].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [bd6404ad-9687-4a7c-a545-946e4439b600].data_input_row
                INNER JOIN [bd6404ad-9687-4a7c-a545-946e4439b600].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
