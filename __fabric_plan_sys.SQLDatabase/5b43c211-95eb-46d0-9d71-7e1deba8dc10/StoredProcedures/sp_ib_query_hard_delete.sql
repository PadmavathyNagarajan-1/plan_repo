      ...
      CREATE   PROCEDURE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_query_writeback] qw
