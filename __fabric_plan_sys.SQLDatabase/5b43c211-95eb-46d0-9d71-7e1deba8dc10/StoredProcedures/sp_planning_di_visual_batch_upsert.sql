        ...
        CREATE   PROCEDURE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [5b43c211-95eb-46d0-9d71-7e1deba8dc10].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [5b43c211-95eb-46d0-9d71-7e1deba8dc10].' + QUOTENAME(@DIVTableName) + ' AS div
