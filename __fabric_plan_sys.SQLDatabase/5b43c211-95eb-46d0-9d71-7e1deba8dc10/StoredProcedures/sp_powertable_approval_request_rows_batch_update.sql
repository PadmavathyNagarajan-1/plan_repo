                          ...
                          CREATE PROCEDURE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [5b43c211-95eb-46d0-9d71-7e1deba8dc10].powertable_approval_request_rows
