CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_row_access_filters]([recordGuid] ASC);
