CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_source] ([id])
);
