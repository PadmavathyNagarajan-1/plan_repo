CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval]([recordGuid] ASC);
