CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval_request] ([id])
);
