CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[writeback_settings]([recordGuid] ASC);
