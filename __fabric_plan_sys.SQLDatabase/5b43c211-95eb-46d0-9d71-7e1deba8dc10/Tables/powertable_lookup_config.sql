CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_lookup_config]([recordGuid] ASC);
