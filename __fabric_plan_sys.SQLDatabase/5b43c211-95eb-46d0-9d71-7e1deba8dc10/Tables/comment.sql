CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[visual] ([id]) ON DELETE CASCADE
);
