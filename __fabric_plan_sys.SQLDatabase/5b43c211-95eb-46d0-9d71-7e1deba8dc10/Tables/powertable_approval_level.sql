CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval_level]([recordGuid] ASC);
