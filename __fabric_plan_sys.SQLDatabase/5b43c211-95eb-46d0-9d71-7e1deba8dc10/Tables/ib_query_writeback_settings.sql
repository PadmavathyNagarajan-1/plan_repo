CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_query_writeback_settings]([recordGuid] ASC);
