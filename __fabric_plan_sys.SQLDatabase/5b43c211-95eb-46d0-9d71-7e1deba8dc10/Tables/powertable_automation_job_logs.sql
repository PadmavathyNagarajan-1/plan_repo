CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_automation_jobs] ([id])
);
