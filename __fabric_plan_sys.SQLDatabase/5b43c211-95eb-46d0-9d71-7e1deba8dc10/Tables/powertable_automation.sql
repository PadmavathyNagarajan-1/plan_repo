CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_automation]([recordGuid] ASC);
