CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[powertable_approval_request] ([id])
);
