CREATE TABLE [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [5b43c211-95eb-46d0-9d71-7e1deba8dc10].[ib_source]([recordGuid] ASC);
