CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_automation_jobs] ([id])
);
