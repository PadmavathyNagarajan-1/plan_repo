CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_forms]([recordGuid] ASC);
