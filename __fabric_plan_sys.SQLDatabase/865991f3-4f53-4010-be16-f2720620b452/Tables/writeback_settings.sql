CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[writeback_settings]([recordGuid] ASC);
