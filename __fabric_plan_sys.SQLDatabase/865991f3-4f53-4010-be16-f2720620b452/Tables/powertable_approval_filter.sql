CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_filter]([recordGuid] ASC);
