CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_lookup_config]([recordGuid] ASC);
