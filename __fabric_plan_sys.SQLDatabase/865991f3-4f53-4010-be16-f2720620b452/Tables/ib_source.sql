CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_source]([recordGuid] ASC);
