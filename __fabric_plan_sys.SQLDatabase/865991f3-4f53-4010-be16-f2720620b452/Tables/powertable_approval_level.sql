CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_level]([recordGuid] ASC);
