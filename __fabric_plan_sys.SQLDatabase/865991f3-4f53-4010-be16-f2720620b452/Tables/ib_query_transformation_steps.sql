CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_query_transformation_steps]([recordGuid] ASC);
