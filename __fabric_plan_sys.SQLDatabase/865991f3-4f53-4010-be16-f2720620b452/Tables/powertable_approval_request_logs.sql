CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_request] ([id])
);
