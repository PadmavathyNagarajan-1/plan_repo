            ...
            CREATE PROCEDURE [865991f3-4f53-4010-be16-f2720620b452].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [865991f3-4f53-4010-be16-f2720620b452].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [865991f3-4f53-4010-be16-f2720620b452].data_input_row
                INNER JOIN [865991f3-4f53-4010-be16-f2720620b452].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
