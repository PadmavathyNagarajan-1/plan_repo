CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_column_config]([recordGuid] ASC);
