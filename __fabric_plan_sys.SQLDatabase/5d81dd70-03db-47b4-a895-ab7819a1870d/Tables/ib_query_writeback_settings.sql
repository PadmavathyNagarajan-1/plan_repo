CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback_settings]([recordGuid] ASC);
