CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_request] ([id])
);
