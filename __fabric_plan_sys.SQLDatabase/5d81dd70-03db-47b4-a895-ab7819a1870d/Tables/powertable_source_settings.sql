CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source_settings]([recordGuid] ASC);
