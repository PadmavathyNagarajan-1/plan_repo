CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_source]([recordGuid] ASC);
