CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_filter]([recordGuid] ASC);
