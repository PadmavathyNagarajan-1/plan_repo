CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[visual] ([id])
);
