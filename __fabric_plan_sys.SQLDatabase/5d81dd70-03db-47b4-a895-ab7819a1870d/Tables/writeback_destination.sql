CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[visual] ([id])
);
