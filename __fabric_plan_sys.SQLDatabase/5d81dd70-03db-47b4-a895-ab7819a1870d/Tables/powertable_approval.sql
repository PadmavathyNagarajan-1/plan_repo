CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval]([recordGuid] ASC);
