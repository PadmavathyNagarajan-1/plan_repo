CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_automation_jobs] ([id])
);
