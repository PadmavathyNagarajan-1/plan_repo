CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_forms]([recordGuid] ASC);
