CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback_destination]([recordGuid] ASC);
