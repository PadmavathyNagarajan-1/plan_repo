CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_row_access_filters]([recordGuid] ASC);
