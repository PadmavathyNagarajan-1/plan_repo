CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_level]([recordGuid] ASC);
