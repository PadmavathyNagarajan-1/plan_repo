CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_automation]([recordGuid] ASC);
