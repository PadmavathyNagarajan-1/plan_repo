CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[visual] ([id]) ON DELETE CASCADE
);
