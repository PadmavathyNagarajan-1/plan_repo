CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [5d81dd70-03db-47b4-a895-ab7819a1870d].[writeback_settings]([recordGuid] ASC);
