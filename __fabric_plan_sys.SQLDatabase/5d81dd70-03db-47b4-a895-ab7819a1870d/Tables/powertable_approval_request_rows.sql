CREATE TABLE [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [5d81dd70-03db-47b4-a895-ab7819a1870d].[powertable_approval_request] ([id])
);
