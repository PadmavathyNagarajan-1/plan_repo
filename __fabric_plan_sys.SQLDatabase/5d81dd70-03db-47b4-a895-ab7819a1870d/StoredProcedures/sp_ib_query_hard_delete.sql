      ...
      CREATE   PROCEDURE [5d81dd70-03db-47b4-a895-ab7819a1870d].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [5d81dd70-03db-47b4-a895-ab7819a1870d].[ib_query_writeback] qw
