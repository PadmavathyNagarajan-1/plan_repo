              ...
              CREATE PROCEDURE [5d81dd70-03db-47b4-a895-ab7819a1870d].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [5d81dd70-03db-47b4-a895-ab7819a1870d].powertable_approval_request_rows SET status = 500 FROM [5d81dd70-03db-47b4-a895-ab7819a1870d].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
