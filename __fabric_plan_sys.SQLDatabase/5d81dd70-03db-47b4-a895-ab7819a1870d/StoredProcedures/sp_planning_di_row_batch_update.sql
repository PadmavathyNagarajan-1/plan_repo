            ...
            CREATE PROCEDURE [5d81dd70-03db-47b4-a895-ab7819a1870d].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [5d81dd70-03db-47b4-a895-ab7819a1870d].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [5d81dd70-03db-47b4-a895-ab7819a1870d].data_input_row
                INNER JOIN [5d81dd70-03db-47b4-a895-ab7819a1870d].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
