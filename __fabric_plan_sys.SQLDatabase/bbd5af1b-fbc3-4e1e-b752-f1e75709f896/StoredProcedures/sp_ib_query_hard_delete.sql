      ...
      CREATE   PROCEDURE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback] qw
