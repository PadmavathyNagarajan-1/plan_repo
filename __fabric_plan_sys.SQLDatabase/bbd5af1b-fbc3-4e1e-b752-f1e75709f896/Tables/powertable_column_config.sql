CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_column_config]([recordGuid] ASC);
