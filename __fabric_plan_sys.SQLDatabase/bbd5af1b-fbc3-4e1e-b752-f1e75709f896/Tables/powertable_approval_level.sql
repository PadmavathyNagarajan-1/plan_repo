CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval_level]([recordGuid] ASC);
