CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_source_settings]([recordGuid] ASC);
