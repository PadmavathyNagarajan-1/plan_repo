CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback_destination]([recordGuid] ASC);
