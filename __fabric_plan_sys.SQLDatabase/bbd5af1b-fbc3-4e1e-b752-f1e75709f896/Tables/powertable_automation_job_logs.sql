CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_automation_jobs] ([id])
);
