CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[visual] ([id])
);
