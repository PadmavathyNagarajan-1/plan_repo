CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_source]([recordGuid] ASC);
