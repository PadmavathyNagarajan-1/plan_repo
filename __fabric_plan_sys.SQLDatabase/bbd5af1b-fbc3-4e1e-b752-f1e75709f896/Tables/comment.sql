CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[visual] ([id]) ON DELETE CASCADE
);
