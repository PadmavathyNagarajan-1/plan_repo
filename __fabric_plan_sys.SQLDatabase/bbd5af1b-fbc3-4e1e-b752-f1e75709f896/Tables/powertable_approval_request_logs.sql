CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval_request] ([id])
);
