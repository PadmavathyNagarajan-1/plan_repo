CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_transformation_steps]([recordGuid] ASC);
