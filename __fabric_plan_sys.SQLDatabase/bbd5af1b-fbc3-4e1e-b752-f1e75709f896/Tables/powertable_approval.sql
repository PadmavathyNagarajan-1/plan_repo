CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval]([recordGuid] ASC);
