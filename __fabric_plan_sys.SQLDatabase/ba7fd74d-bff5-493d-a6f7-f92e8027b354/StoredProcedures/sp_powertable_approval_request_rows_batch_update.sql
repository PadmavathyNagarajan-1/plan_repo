                          ...
                          CREATE PROCEDURE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [ba7fd74d-bff5-493d-a6f7-f92e8027b354].powertable_approval_request_rows
