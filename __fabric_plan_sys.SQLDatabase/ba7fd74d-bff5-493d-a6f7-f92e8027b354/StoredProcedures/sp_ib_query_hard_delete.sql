      ...
      CREATE   PROCEDURE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback] qw
