              ...
              CREATE PROCEDURE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].powertable_approval_request_rows SET status = 500 FROM [ba7fd74d-bff5-493d-a6f7-f92e8027b354].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
