        ...
        CREATE   PROCEDURE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [ba7fd74d-bff5-493d-a6f7-f92e8027b354].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [ba7fd74d-bff5-493d-a6f7-f92e8027b354].' + QUOTENAME(@DIVTableName) + ' AS div
