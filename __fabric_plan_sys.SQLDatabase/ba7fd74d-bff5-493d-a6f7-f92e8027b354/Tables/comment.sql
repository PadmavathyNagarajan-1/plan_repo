CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[visual] ([id]) ON DELETE CASCADE
);
