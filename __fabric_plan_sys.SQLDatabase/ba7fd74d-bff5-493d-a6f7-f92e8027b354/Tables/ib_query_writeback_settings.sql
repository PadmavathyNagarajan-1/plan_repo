CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback_settings]([recordGuid] ASC);
