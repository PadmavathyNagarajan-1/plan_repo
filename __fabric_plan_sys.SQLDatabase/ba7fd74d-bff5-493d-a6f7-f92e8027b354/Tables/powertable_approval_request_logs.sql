CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_request] ([id])
);
