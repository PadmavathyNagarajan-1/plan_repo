CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_automation]([recordGuid] ASC);
