CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_row_access_filters]([recordGuid] ASC);
