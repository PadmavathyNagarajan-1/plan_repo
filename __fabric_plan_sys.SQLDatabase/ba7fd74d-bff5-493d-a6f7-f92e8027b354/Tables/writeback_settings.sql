CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[writeback_settings]([recordGuid] ASC);
