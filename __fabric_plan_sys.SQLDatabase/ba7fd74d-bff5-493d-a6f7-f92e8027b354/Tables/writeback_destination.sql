CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[visual] ([id])
);
