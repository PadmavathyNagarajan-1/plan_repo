CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source_settings]([recordGuid] ASC);
