CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_forms]([recordGuid] ASC);
