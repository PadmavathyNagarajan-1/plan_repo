CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_source]([recordGuid] ASC);
