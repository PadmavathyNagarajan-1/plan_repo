CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_automation_jobs] ([id])
);
