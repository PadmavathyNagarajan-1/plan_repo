CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_writeback_destination]([recordGuid] ASC);
