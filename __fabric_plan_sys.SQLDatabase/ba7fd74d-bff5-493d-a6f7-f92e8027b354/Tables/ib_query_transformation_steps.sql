CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[ib_query_transformation_steps]([recordGuid] ASC);
