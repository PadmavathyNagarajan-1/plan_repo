CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_filter]([recordGuid] ASC);
