CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_column_config]([recordGuid] ASC);
