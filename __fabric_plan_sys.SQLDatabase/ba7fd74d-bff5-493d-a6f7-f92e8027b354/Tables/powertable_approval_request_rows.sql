CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_request] ([id])
);
