CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_approval_level]([recordGuid] ASC);
