CREATE TABLE [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [ba7fd74d-bff5-493d-a6f7-f92e8027b354].[powertable_lookup_config]([recordGuid] ASC);
