      ...
      CREATE   PROCEDURE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback] qw
