        ...
        CREATE   PROCEDURE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].' + QUOTENAME(@DIVTableName) + ' AS div
