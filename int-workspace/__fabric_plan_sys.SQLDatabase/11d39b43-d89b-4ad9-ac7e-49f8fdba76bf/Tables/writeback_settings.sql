CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[writeback_settings]([recordGuid] ASC);
