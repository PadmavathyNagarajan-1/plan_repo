CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[ib_query_writeback_settings]([recordGuid] ASC);
