CREATE TABLE [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [11d39b43-d89b-4ad9-ac7e-49f8fdba76bf].[powertable_approval_request] ([id])
);
