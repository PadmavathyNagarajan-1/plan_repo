                ...
                CREATE PROCEDURE [865991f3-4f53-4010-be16-f2720620b452].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [865991f3-4f53-4010-be16-f2720620b452].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
