              ...
              CREATE PROCEDURE [865991f3-4f53-4010-be16-f2720620b452].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [865991f3-4f53-4010-be16-f2720620b452].powertable_approval_request_rows SET status = 500 FROM [865991f3-4f53-4010-be16-f2720620b452].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
