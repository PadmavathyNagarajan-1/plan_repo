                          ...
                          CREATE PROCEDURE [865991f3-4f53-4010-be16-f2720620b452].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [865991f3-4f53-4010-be16-f2720620b452].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [865991f3-4f53-4010-be16-f2720620b452].powertable_approval_request_rows
