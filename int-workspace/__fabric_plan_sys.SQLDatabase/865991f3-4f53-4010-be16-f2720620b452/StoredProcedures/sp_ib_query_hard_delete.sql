      ...
      CREATE   PROCEDURE [865991f3-4f53-4010-be16-f2720620b452].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [865991f3-4f53-4010-be16-f2720620b452].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback] qw
