CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback_settings]([recordGuid] ASC);
