CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval]([recordGuid] ASC);
