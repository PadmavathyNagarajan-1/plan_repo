CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_row_access_filters]([recordGuid] ASC);
