CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_source_settings]([recordGuid] ASC);
