CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[ib_query_writeback_destination]([recordGuid] ASC);
