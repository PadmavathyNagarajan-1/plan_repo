CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_approval_request] ([id])
);
