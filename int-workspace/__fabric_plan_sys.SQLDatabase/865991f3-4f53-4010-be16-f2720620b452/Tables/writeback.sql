CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[visual] ([id])
);
