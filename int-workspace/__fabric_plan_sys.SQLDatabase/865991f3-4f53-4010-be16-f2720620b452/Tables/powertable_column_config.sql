CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [865991f3-4f53-4010-be16-f2720620b452].[powertable_column_config]([recordGuid] ASC);
