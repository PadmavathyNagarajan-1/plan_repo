CREATE TABLE [865991f3-4f53-4010-be16-f2720620b452].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [865991f3-4f53-4010-be16-f2720620b452].[visual] ([id]) ON DELETE CASCADE
);
