        ...
        CREATE   PROCEDURE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].' + QUOTENAME(@DIVTableName) + ' AS div
