              ...
              CREATE PROCEDURE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].powertable_approval_request_rows SET status = 500 FROM [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
