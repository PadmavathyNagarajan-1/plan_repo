CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_lookup_config]([recordGuid] ASC);
