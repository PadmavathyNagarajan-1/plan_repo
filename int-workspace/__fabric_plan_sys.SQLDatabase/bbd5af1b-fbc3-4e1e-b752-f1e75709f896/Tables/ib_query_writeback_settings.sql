CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[ib_query_writeback_settings]([recordGuid] ASC);
