CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[writeback_settings]([recordGuid] ASC);
