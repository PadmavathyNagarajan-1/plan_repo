CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[writeback_destination] (
    ...
    CONSTRAINT [FK_0ddd09926ffe2915c880b726bb7] FOREIGN KEY ([visualId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[visual] ([id])
);
