CREATE TABLE [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [bbd5af1b-fbc3-4e1e-b752-f1e75709f896].[powertable_approval_filter]([recordGuid] ASC);
