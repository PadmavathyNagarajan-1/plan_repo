CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[visual] ([id])
);
