CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_lookup_config]([recordGuid] ASC);
