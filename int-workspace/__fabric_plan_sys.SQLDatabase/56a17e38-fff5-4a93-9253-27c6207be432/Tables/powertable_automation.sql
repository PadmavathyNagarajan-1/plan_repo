CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_automation]([recordGuid] ASC);
