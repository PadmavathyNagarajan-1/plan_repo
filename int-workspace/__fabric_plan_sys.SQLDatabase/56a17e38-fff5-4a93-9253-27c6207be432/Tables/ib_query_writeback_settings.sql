CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_writeback_settings]([recordGuid] ASC);
