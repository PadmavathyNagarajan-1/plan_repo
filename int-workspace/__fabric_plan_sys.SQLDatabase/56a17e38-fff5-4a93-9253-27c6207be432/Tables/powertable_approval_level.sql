CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_level]([recordGuid] ASC);
