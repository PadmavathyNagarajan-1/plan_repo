CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_forms]([recordGuid] ASC);
