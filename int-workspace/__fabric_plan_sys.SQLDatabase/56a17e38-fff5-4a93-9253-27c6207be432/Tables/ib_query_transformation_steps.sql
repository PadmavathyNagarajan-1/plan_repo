CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[ib_query_transformation_steps]([recordGuid] ASC);
