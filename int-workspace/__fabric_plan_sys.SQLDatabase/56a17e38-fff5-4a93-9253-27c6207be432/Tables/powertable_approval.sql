CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval]([recordGuid] ASC);
