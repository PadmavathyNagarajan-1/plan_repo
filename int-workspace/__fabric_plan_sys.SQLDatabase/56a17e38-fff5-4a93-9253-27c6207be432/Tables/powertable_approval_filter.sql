CREATE TABLE [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [56a17e38-fff5-4a93-9253-27c6207be432].[powertable_approval_filter]([recordGuid] ASC);
